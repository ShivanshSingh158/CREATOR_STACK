export const NICHES = [
  // Gaming
  'PC Gaming', 'Console Gaming', 'Mobile Gaming', 'Esports', 'Retro Gaming', 'VR Gaming', 'Tabletop Gaming',
  
  // Tech & Software
  'Consumer Tech', 'Tech Hardware', 'B2B SaaS', 'Software Development', 'AI & Machine Learning', 'Data Science', 'Cybersecurity', 'Crypto & Web3',
  
  // Business & Finance
  'Personal Finance', 'Stock Trading', 'Real Estate Investing', 'FinTech', 'Entrepreneurship', 'Marketing & SEO', 'E-commerce',
  
  // Education & Productivity
  'EdTech', 'Language Learning', 'Productivity & Notion', 'Career Advice', 'Science & Engineering', 'History & Culture',
  
  // Lifestyle & Vlogs
  'Daily Vlogs', 'Travel Vlogs', 'Van Life', 'Minimalism', 'Digital Nomad', 'Parenting & Family',
  
  // Beauty & Fashion
  'Makeup Tutorials', 'Skincare', 'Streetwear', 'High Fashion', 'Sneakerhead', 'Men\'s Grooming',
  
  // Health & Fitness
  'Home Workouts', 'Bodybuilding', 'Yoga & Mindfulness', 'Nutrition & Diet', 'Running & Endurance',
  
  // Food & Cooking
  'Home Cooking', 'Baking', 'Restaurant Reviews', 'Vegan/Plant-Based', 'Mixology & Drinks',
  
  // Automotive
  'Car Reviews', 'Motorcycles', 'Car Tuning', 'EVs & Green Tech',
  
  // Entertainment & Art
  'Comedy Sketches', 'Movie Reviews', 'Anime & Manga', 'Music Production', 'Photography', 'Videography', 'Digital Art'
];
...
export const RELATED_NICHES: Record<string, string[]> = {
  ...
  'B2B SaaS': ['Software Development', 'Marketing & SEO', 'Entrepreneurship', 'AI & Machine Learning'],
