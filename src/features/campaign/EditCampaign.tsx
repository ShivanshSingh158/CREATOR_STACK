  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#fafaf9] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] flex flex-col items-center justify-center p-6 font-['Inter']">
        ...
        <p className="mt-4 text-[10px] font-black text-indigo-600 uppercase tracking-widest animate-pulse">
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] text-black font-['Inter'] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <button
          onClick={() => navigate(-1)}
          className="text-black hover:text-indigo-600 text-[10px] font-black uppercase tracking-widest mb-8 flex items-center gap-2 transition-colors"
        >
        ...
        <div className="mb-10">
          ...
          <p className="text-sm font-bold text-gray-500 uppercase tracking-widest">
            Modify your deal terms and push updates to the creator network.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8 sm:p-10 space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div>
                <h2 className="text-[10px] font-black uppercase tracking-widest text-black border-b-2 border-black pb-3 mb-6">
                  CORE DETAILS
                </h2>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full bg-white border-2 border-black rounded-lg p-3.5 text-sm font-bold text-black focus:outline-none focus:border-indigo-600 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all appearance-none cursor-pointer"
                      >
                        {NICHES.map((n) => (
            ...
            <div className="pt-8 mt-8 border-t-2 border-black flex flex-col-reverse sm:flex-row justify-end gap-4">
              <button
                type="button"
                onClick={() => navigate(-1)}
                className="w-full sm:w-auto bg-gray-100 text-black border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] font-black py-4 px-8 rounded uppercase tracking-widest text-[10px] hover:bg-gray-200 hover:-translate-y-0.5 active:translate-y-0 active:shadow-none transition-all"
              >
                CANCEL
              </button>
              <button
