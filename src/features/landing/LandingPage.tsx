      ...
      <div className="relative pt-24 pb-32 overflow-hidden bg-grid-pattern border-b-2 border-matte-900">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-8 leading-[1.1] uppercase">
            ...
            <span className="block text-brand-600 drop-shadow-[4px_4px_0px_#121212]">
              meet creators.
            </span>
          </h1>

          <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-matte-800 mb-12 font-medium">
            The anti-boring platform to manage your campaigns, applications, and payouts securely.
            No fluff, just authentic collaborations.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card bg-white hover:-rotate-1 transition-transform group">
              <div className="w-16 h-16 bg-accent-neon border-2 border-matte-900 rounded-2xl shadow-brutal-sm flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <svg
                  className="w-8 h-8 text-matte-900"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <h3 className="text-2xl font-black text-matte-900 uppercase tracking-wide mb-4">
                For Creators
              </h3>
              <p className="text-lg text-matte-800 font-medium">
                Discover top brands, apply to high-paying campaigns, and manage all your
                deliverables in one chaotic-free dashboard.
              </p>
            </div>
            ...
            <div className="card bg-brand-600 text-white hover:rotate-1 transition-transform group">
              ...
              <p className="text-lg text-brand-50 font-medium">
                Launch campaigns effortlessly, receive applications from verified creators, and
                track your true ROI.
              </p>
            </div>
            ...
            <div className="card bg-matte-900 text-white hover:-rotate-1 transition-transform group">
              ...
              <p className="text-lg text-gray-300 font-medium">
                Secure transactions, transparent metrics, and authentic partnerships built on
                algorithmic trust.
              </p>
            </div>
          </div>
